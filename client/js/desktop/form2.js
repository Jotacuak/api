        ...
        for(let tab in this.formStructure.tabs) {
            ...
            for (let row in this.formStructure.tabsContent[tab].rows) {
                ...
                for(let field in this.formStructure.tabsContent[tab].rows[row].formElements) {
                    ...
                    let formElementStructure = this.formStructure.tabsContent[tab].rows[row].formElements[field];
                    ...
                    Object.keys(formElementStructure).forEach(attribute => {
                        ...
                        switch(attribute) {
                            ...
                            default:
                                ...
                                formElement.setAttribute(attribute, formElement[attribute]);
                        }
                    });
                            ...
                            rows:{
                                row1: {
                                    formElements:{
                                        flyer: {
                                            label: 'Flyer',
                                            element: 'upload-image-button-component',
                                            type: 'file',
                                            languageAlias: 'es'
                                        },
                                    }
